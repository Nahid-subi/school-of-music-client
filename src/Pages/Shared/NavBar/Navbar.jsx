...
const Navbar = () => {
    ...
    const navLinkLi = <>
        ...
        {
            user ? <li><Link to="dashboard/welcome">Dashboard</Link></li> : <></>
        }
    </>
    ...
    const loginButton = <>
        ...
        {
            user ? <><Link onClick={handleLogOut} className="btn btn-yellow">Logout</Link>
                <img className='w-12 h-12 mx-2 rounded-full' src={user.photoURL} alt="" title={user.displayName} />
            </> :
